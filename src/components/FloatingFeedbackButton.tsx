...
export default function FloatingFeedbackButton({ onClick }: FloatingFeedbackButtonProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="fixed bottom-4 right-3 sm:bottom-6 sm:right-6 w-11 h-11 sm:w-14 sm:h-14 rounded-full shadow-md sm:shadow-lg transition-all duration-300 z-40 bg-white dark:bg-gray-800 border-2 border-primary-200 dark:border-primary-800 hover:border-primary-400 dark:hover:border-primary-500 hover:scale-110 active:scale-95"
